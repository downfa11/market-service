package com.ns.marketservice.Utils;
/*
...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        List<String> list = Arrays.asList(
                "/membership/login-temp",  // 로그인 페이지의 URL을 추가합니다.
                "/login",  // 로그인 페이지의 URL을 추가합니다.
                "/css/**",
                "/js/**",
                "/images/**"
        );
        log.info("curURI :"+request.getRequestURI());
        ...
        try {
            ...
            if (token != null && !token.equalsIgnoreCase("")) {
                ...
                if (jwtTokenProvider.validateJwtToken(token)) {
                    ...
                    String loginId = jwtTokenProvider.parseMembershipIdFromToken(token).toString();
                ...
                // [STEP.2-5] 토큰이 유효하지 않은 경우
                    ...
                    throw new RuntimeException("TOKEN_NOT_VALID");
                }
            }
